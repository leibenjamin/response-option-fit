...
const llmOutputRedTeamPrompt = `Red-team an research tool-generated review or rewrite of my own survey question. Do not assume the output is correct.

Original question and answer choices:
[paste original item]

research tool output to review:
...
export const promptCards: readonly PromptCard[] = [
  ...
  },
  {
    ...
    title: "research tool-output red-team review",
    purpose:
